    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
        ...
        <div className="fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none">
          ...
          {/* INICIO DE LA MODIFICACIÓN: Se añade el botón de contacto aquí */}
          <div className="flex items-center gap-4">
            <a href="mailto:info@lextrace.com" className="rounded-lg border border-transparent px-4 py-2 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30">
              <TranslatedText translationKey="cta_contact" />
            </a>
            
            <div className="flex place-items-center gap-2 p-8 lg:p-0">
              <TranslatedText translationKey="attribution_by" />{' '}
              <Image
                src="/InkTronicBrand.png"
                alt="Logo inferior"
